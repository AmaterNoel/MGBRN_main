...
class TST_Rand(nn.Module):
    def __init__(self, num_frames, num_queries, device):
        super(TST_Rand, self).__init__()
        ...
        self.query_embed = nn.Embedding(num_queries, self.embed_dim)
...
class TST_Rand_NH(nn.Module):
    def __init__(self, num_frames, num_queries, device):
        super(TST_Rand_NH, self).__init__()
        self.frames = num_frames
        self.device = device
        self.embed_dim = 256
        self.num_action_class = num_queries
