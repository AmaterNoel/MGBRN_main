...
parser.add_argument("--save_last_pt", default='path/last_new_16_768', help="The address where the model is stored after training is completed, Default: path or None")
parser.add_argument("--save_best_pt", default='path/best_new_16_768', help="The address where the model is stored after training is completed, Default: path or None")
...
train_sampler = torch.utils.data.RandomSampler(train_set, num_samples=20)
...
test_sampler = torch.utils.data.RandomSampler(test_set, num_samples=20)
