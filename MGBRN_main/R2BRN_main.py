...
from model.R2_model import *
from dataset import *

parser = argparse.ArgumentParser(description='MBBRN')
parser.add_argument("--seed", default=1, type=int, help="Seed for Numpy and PyTorch. Default: -1 (None)")
parser.add_argument("--device", default='cuda:2', type=str, help="0, 1, 2, 3, 4, 5, 6, 7")
...
parser.add_argument("--save_last_pt", default='path/R2_last_768', help="The address where the model is stored after training is completed, Default: path or None")
parser.add_argument("--save_best_pt", default='path/R2_best_768', help="The address where the model is stored after training is completed, Default: path or None")
...
if opt.TST_type == "withoutFFIN":
    TST_model = RTwithoutFFIN(num_queries=len(action_class_list), frames=opt.frames, device=device).to(device)
